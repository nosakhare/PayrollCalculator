...
icons = {
    ...
    "debug": """
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        <path d="M14.5 11a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9zm0-7.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm7.31 7.5l-2.33-2.33A8.01 8.01 0 0 0 21 3a1 1 0 1 0-2 0 6.01 6.01 0 0 1-1.39 3.84L14.92 4.3a1 1 0 1 0-1.42 1.4l2.61 2.6c-.46.15-.95.25-1.45.3a1 1 0 0 0-.93.91A6.81 6.81 0 0 1 12.5 12a6.25 6.25 0 0 1-6.2-5.06 1 1 0 0 0-1-.84 1 1 0 0 0-.83.42 1 1 0 0 0-.15.92A8.28 8.28 0 0 0 9 12.48v.5l-1.82 1.82a1 1 0 1 0 1.42 1.4l1.43-1.43a8.55 8.55 0 0 0 4.91 0l1.43 1.43a1 1 0 0 0 1.42-1.4L16 13v-.52c1.02-.33 2.2-.98 3.11-1.68l2.7 2.7a1 1 0 1 0 1.4-1.42l-1.4-1.4zm-12.52.93a2.93 2.93 0 0 0 2.43 2.43 1 1 0 0 1-.44.89 1 1 0 0 1-.99 0 4.95 4.95 0 0 1-3.12-3.12 1 1 0 0 1 0-1 1 1 0 0 1 .9-.43 2.93 2.93 0 0 0 1.22 1.22z"/>
    </svg>
    """,
}
